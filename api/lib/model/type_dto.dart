...
class TypeDto {
  /// Returns a new [TypeDto] instance.
  TypeDto({
    this.id,
    this.typeName,
    this.description,
  ...
  /// Returns a new [TypeDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TypeDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<TypeDto> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TypeDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TypeDto> mapFromJson(dynamic json) {
    final map = <String, TypeDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TypeDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
