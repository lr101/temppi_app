...
void main() {
  ...
  group('tests for SensorCategoriesApi', () {
    // Create a new sensor category
    //
    //Future<CategoryDto> createSensorCategory(CategoryDto categoryDto) async
    test('test createSensorCategory', () async {
      // TODO
    });

    // Delete a sensor category by ID
    //
    //Future deleteSensorCategory(int categoryId) async
    test('test deleteSensorCategory', () async {
      // TODO
    });
    ...
    test('test getAllSensorCategories', () async {
      // TODO
    });
    ...
    test('test getSensorCategoryById', () async {
      // TODO
    });
